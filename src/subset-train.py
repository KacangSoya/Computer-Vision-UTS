...
# Baca file CSV
data = pd.read_csv(r'C:\Users\habib\Downloads\Compressed\archive_5\emnist-bymerge-train.csv')
...
samples_per_class = 1000 // num_classes  # Sampel merata per kelas
...
if len(balanced_data) > 1000:
    balanced_data = balanced_data.sample(1000)
