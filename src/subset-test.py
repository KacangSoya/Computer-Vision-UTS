...
test_data = pd.read_csv(r'C:\Users\habib\Downloads\Compressed\archive_5\emnist-bymerge-test.csv')
...
samples_per_class_test = 1000 // num_classes  # Contoh: set 750 sampel untuk data uji
...
if len(balanced_test_data) > 1000:
    balanced_test_data = balanced_test_data.sample(1000)
